 ...
 */
class Holds extends IframeBase
{
   public function page()
    {
        ...
        //根据把查询
        if($bundle_code != ''){
            $result = doCurlGetRequest(['handleCode'=>$bundle_code],'/buss_center/outer/mbank/handle/gzhInfo',$interfaceUrl);
            ...
            //根据捆查询
            $result = doCurlGetRequest(['bundleCode'=>$bundleCode],'/buss_center/outer/mbank/handle/handleInfo',$interfaceUrl);
        }
